...
class ViewRouter: ObservableObject {
    @Published var currentPage: Page = .Splash //setting the original value of currentPage and as an @published value so that all structs are updated when its value changes
